...
function createCountryChart() {
    ...
    originalColorsCountry = ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0', '#9966FF', '#C9CBCF', '#009A44', '#05445E'];
...
function updateCountryChart(filteredData) {
    ...
    const colorsCountry = ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0', '#9966FF', '#C9CBCF', '#009A44', '#05445E'];
